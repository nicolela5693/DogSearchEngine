...
public class GoogleQuery {
	...
	public GoogleQuery(String searchKeyword){
		...
		//this.url = "https://petsmao.nownews.com/?s=" + searchKeyword;
...
//		Elements div_rcs = document.select("div.fusion-post-content");
//		  
//		  
//		  
//		  for(Element div_rc : div_rcs){
//		   Element h3 = div_rc.select("h2.entry-title").get(0);
//		   String title = h3.text();
//		   
//		   Element cite = div_rc.select("a").first();
//		   String linkHref = cite.attr("href");
//
//		   
